  ...
  render () {
    return (
      <Scene physics="debug: true">
        ...
        <a-plane static-body src="#chantilly" repeat="14 14" position="0 0 -7" rotation="0 0 0" height="14" width="14"/>
        <a-plane static-body src="#chantilly" repeat="14 14" position="0 0 7" rotation="0 180 0" height="14" width="14"/>
        <a-plane static-body src="#chantilly" repeat="14 14" position="7 0 0" rotation="0 -90 0" height="14" width="14"/>
        <a-plane static-body src="#chantilly" repeat="14 14" position="-7 0 0" rotation="0 90 0" height="14" width="14"/>
